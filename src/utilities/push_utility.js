...
import { getMedia }                     from '../actions/medium_actions';
...
export const setPusherClient = (authToken, clientId) => (dispatch) => {
  ...
  myChannel.bind('receive-message', (data) => {
    ...
    dispatch(getMedia(data.message));
  });
