...
import MenuScreenContainer                         from '../components/menu_screen/menu_screen_container.js';
  ...
  MainTabNavigator: {
    ...
    navigationOptions: ({navigation}) => ({
      headerTitle: <RN.Image
        ...
        resizeMode='contain'
      />,
      headerRight: <Icon name='options-vertical' onPress={() => navigation.dispatch(toMenuScreen(getCurrentRoute(navigation.state)))} style={styles.optionsIcon} />,
      headerLeft:  <Icon name='note' onPress={() => navigation.dispatch(toNewPostScreen(getCurrentRoute(navigation.state)))} style={styles.noteIcon} />,
    })
   },
  NewPostScreen: { screen: NewPostScreenContainer },
  MenuScreen: { screen: MenuScreenContainer }
});
